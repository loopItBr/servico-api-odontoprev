 ...
 *
 * FUNÇÃO PRINCIPAL:
 * Esta classe representa a VIEW VW_INTEGRACAO_ODONTOPREV_BENEFICIARIOS_EXC.sql que consolida
 ...
 * 8. MOTIVO DE EXCLUSÃO: motivo da inativação
 *
 * USO NO SISTEMA:
...
public class IntegracaoOdontoprevBeneficiarioExclusao {
     ...
     *
     * E = Exclusão (sempre E para esta view)
     */
     ...
     *
     * ID específico do motivo de inativação para a OdontoPrev.
     * Campo obrigatório para exclusão.
     */
     ...
     * DATA DE INATIVAÇÃO
     *
     * Data em que o beneficiário foi inativado.
     */
